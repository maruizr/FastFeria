...
CREATE TABLE FASTFERIA.contratos (
    ...
    usuarios_rut            VARCHAR2(9) NOT NULL,
...
ALTER TABLE FASTFERIA.saldos
    ADD CONSTRAINT saldos_usuarios_fk FOREIGN KEY ( usuarios_rut )
        REFERENCES FASTFERIA.usuarios ( rut_usr );
...
ALTER TABLE FASTFERIA.metodo_pago
    ADD CONSTRAINT metodo_pago_usuarios_fk FOREIGN KEY ( usuarios_rut )
        REFERENCES FASTFERIA.usuarios ( rut_usr );

ALTER TABLE FASTFERIA.contratos
    ADD CONSTRAINT contratos_usuarios_fk FOREIGN KEY ( usuarios_rut )
        REFERENCES FASTFERIA.usuarios ( rut_usr );
...
ALTER TABLE FASTFERIA.pedido
    ADD CONSTRAINT pedido_usuarios_fk FOREIGN KEY ( usuarios_rut )
        REFERENCES FASTFERIA.usuarios ( rut_usr );
...
ALTER TABLE FASTFERIA.productos
    ADD CONSTRAINT productos_usuarios_fk FOREIGN KEY ( usuarios_rut )
        REFERENCES FASTFERIA.usuarios ( rut_usr );

ALTER TABLE FASTFERIA.report_merma
    ADD CONSTRAINT report_merma_usuarios_fk FOREIGN KEY ( usuarios_rut )
        REFERENCES FASTFERIA.usuarios ( rut_usr );
...
ALTER TABLE FASTFERIA.reportes
    ADD CONSTRAINT reportes_usuarios_fk FOREIGN KEY ( usuarios_rut )
        REFERENCES FASTFERIA.usuarios ( rut_usr );
...
ALTER TABLE FASTFERIA.transporte
    ADD CONSTRAINT transporte_usuarios_fk FOREIGN KEY ( usuarios_rut )
        REFERENCES FASTFERIA.usuarios ( rut_usr );
